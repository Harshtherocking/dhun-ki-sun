...
def plot_waveform_with_spectral_centroid(amp, sr, spectral_centroid):
    """
    Plots the waveform and spectral centroid of an audio signal.

    Args:
        amp (numpy.ndarray): Audio waveform data.
        sr (int): Sample rate of the audio.
        spectral_centroid (numpy.ndarray): Spectral centroid values.
    """
    try:
...
if __name__ == "__main__":
    ...
    # Plot waveform with spectral centroid
    plot_waveform_with_spectral_centroid(amp, sr, spectral_centroid)
